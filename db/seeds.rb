...
#Create test levels
level_1 = Level.create(:title => "Paris is Burning", :prompt => "Find out how many people will die by selecting the population of Paris.", :database_path =>"db/dumps/lvl1.sql", :stage_number=> 1, :answer=>"[{\"population\"=>\"8000000\"}]")
...
level_2 = Level.create(:title => "Shoot down the nuke about to kill your family!", :prompt => "Alter the strength of Tsar Bomba so it is 1 megaton", :database_path =>"db/dumps/lvl2.sql", :stage_number=> 2, :answer=>"[{\"1134000\"}]")
